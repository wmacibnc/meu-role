...
* Fork the repo
* Your must enter your database information and your email in form-handler.php - if you don't have a database, that's fine.  Edit contact.php to direct the form to form-handler-nodb.php and emails will be sent with no database writes.
